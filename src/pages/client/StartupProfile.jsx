...
const translations = {
  ...
  ar: {
    ...
    myStartups: 'شركاتي',
    manageProfiles: 'إدارة ملفات الشركات الناشئة',
    addStartup: 'إضافة شركة',
    startupCreated: 'تم إنشاء الشركة!',
    createFailed: 'فشل الإنشاء',
    startupUpdated: 'تم التحديث!',
    updateFailed: 'فشل التحديث',
    startupDeleted: 'تم الحذف!',
    deleteFailed: 'فشل الحذف',
    editStartup: 'تعديل الشركة',
    createNewStartup: 'شركة جديدة',
    startupName: 'اسم الشركة',
    startupNameRequired: 'الاسم مطلوب',
    yourPosition: 'منصبك',
    positionRequired: 'المنصب مطلوب',
    numberOfEmployees: 'عدد الموظفين',
    employeesRequired: 'العدد مطلوب',
    employees1to5: '1–5',
    employees6to10: '6–10',
    employees11to20: '11–20',
    employees21to50: '21–50',
    employees51to100: '51–100',
    employees100plus: '100+',
    startupIndustry: 'مجال الشركة',
    industryRequired: 'المجال مطلوب',
    specifyIndustry: 'حدّد المجال',
    specifyIndustryRequired: 'حدّد المجال',
    ...
    socialLinksOptional: 'روابط (اختياري)',
    updateStartup: 'تحديث',
    createStartup: 'إنشاء',
    cancel: 'إلغاء',
    myStartupsCount: 'شركاتي ({count})',
    noStartupsYet: 'لم تنشئ أي شركة بعد.',
    employees: 'الموظفون:',
    industry: 'المجال:',
    stage: 'المرحلة:',
    created: 'أُنشئ:',
    ...
    visit: 'زيارة',
    deleteStartup: 'حذف',
    deleteConfirm: 'هل تريد حذف هذه الشركة؟ لا رجوع.',
    delete: 'حذف',
  },
};
