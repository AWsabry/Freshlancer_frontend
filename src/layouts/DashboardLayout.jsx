...
const translations = {
  en: {
    ...
    educationBadgeGrants: 'Badge grants',
    educationBadgeRequests: 'Badge requests',
    educationBadgeAwards: 'Student awards',
    logs: 'Audit Logs',
  ...
  it: {
    ...
    educationBadgeGrants: 'Assegnazione badge',
    educationBadgeRequests: 'Richieste badge',
    educationBadgeAwards: 'Badge studenti',
    logs: 'Log di Audit',
  ...
  ar: {
    ...
    educationBadgeGrants: 'منح الشارات',
    educationBadgeRequests: 'طلبات الشارات',
    educationBadgeAwards: 'شارات الطلاب',
    logs: 'سجلات التدقيق',
  ...
  const getNavigationItems = () => {
    ...
    if (user?.role === 'admin') {
      return [
        ...
        { name: t.educationPartners, icon: GraduationCap, path: '/admin/education-partners' },
        { name: t.educationBadgeGrants, icon: Award, path: '/admin/education-badges/grants' },
        { name: t.educationBadgeRequests, icon: Award, path: '/admin/education-badges/requests' },
        { name: t.educationBadgeAwards, icon: FileText, path: '/admin/education-badges/awards' },
