...
const translations = {
  ...
  ar: {
    ...
    subtitle: 'أدِر إعلانات الوظائف وتواصل مع الطلاب المتميزين',
    totalApplications: 'إجمالي الطلبات',
    receivedForJobs: 'المستلمة لوظائفك',
    totalJobsPosted: 'إجمالي الوظائف المنشورة',
    jobsCreated: 'الوظائف التي أنشأتها',
    unlockedProfiles: 'الملفات المفتوحة',
    studentContactsUnlocked: 'جهات اتصال الطلاب المفتوحة',
    quickActions: 'إجراءات سريعة',
    postNewJob: 'نشر وظيفة جديدة',
    postNewJobDesc: 'أنشئ وظيفة جديدة للطلاب',
    myJobs: 'وظائفي',
    myJobsDesc: 'اعرض وأدِر إعلاناتك',
    applications: 'الطلبات',
    applicationsDesc: 'راجع طلبات الطلاب',
    packages: 'الباقات',
    packagesDesc: 'اشترِ باقات النقاط',
    transactionHistory: 'سجل المعاملات',
    transactionHistoryDesc: 'اعرض سجل الدفع',
    gettingStarted: 'البدء',
    step1: 'انقر «نشر وظيفة جديدة» لإنشاء أول إعلان',
    step2: 'سيرى الطلاب وظيفتك ويمكنهم التقديم بمقترحات منظمة',
    step3: 'راجع الطلبات واختر الأنسب لمشاريعك',
    platformBenefits: 'مزايا المنصة',
    benefit1: 'وصول لطلاب مستقلين موهوبين',
    benefit2: 'آلية تقديم منظمة',
    benefit3: 'حلول مناسبة التكلفة لمشاريعك',
    benefit4: 'سهولة إدارة الوظائف والمتابعة',
  },
};
