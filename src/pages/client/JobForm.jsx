...
const translations = {
  ...
  ar: {
    ...
    backToMyJobs: 'العودة إلى وظائفي',
    editJobPost: 'تعديل إعلان الوظيفة',
    createNewJobPost: 'إعلان وظيفة جديد',
    fillRequiredFields:
      'املأ الحقول المطلوبة لنشر وظيفتك. سيتمكّن الطلاب من التصفح والتقديم.',
    jobTitle: 'عنوان الوظيفة',
    jobTitlePlaceholder: 'مثال: مطوّر ويب Full-Stack',
    jobTitleRequired: 'أدخل عنواناً للوظيفة',
    jobDescription: 'وصف الوظيفة',
    jobDescriptionPlaceholder: 'صف المشروع والمتطلبات والمخرجات...',
    jobDescriptionRequired: 'صف الوظيفة وما تحتاجه',
    category: 'التصنيف',
    categoryRequired: 'اختر تصنيفاً',
    skillsRequired: 'المهارات المطلوبة',
    addSkill: 'أضف مهارة (مثل React, Node.js)',
    minimumBudget: 'الحد الأدنى للميزانية',
    minimumBudgetRequired: 'أدخل حداً أدنى',
    minimumBudgetMin: 'الحد الأدنى 1 على الأقل',
    maximumBudget: 'الحد الأقصى',
    maximumBudgetRequired: 'أدخل حداً أقصى',
    maximumBudgetValidate: 'الحد الأقصى يجب أن يكون ≥ الحد الأدنى',
    currency: 'العملة',
    currencyRequired: 'اختر العملة',
    projectDuration: 'مدة المشروع',
    projectDurationRequired: 'اختر المدة المتوقعة',
    selectDuration: 'اختر المدة',
    durationLessThanWeek: 'أقل من أسبوع',
    duration1to2Weeks: '1–2 أسبوع',
    duration2to4Weeks: '2–4 أسابيع',
    duration1to3Months: '1–3 أشهر',
    durationMoreThan3Months: 'أكثر من 3 أشهر',
    deadlineOptional: 'الموعد النهائي (اختياري)',
    deadlineValidate: 'إن حددت موعداً يجب أن يكون في المستقبل',
    experienceLevel: 'مستوى الخبرة',
    experienceLevelRequired: 'اختر مستوى الخبرة المطلوب',
    experienceBeginner: 'مبتدئ',
    experienceIntermediate: 'متوسط',
    experienceAdvanced: 'متقدم',
    experienceExpert: 'خبير',
    thisJobForStartup: 'هذه الوظيفة لإحدى شركاتي الناشئة',
    selectStartup: 'اختر الشركة',
    selectStartupRequired: 'اختر شركة ناشئة',
    cancel: 'إلغاء',
    updateJob: 'تحديث الوظيفة',
    postJob: 'نشر الوظيفة',
    jobUpdated: 'تم تحديث الوظيفة!',
    jobPosted: 'تم نشر الوظيفة!',
    couldNotUpdate: 'تعذر تحديث الإعلان. راجع المعلومات.',
    couldNotCreate: 'تعذر إنشاء الإعلان. راجع المعلومات.',
    titleInvalid: 'عنوان صالح (5–100 حرفاً)',
    descriptionInvalid: 'وصف مفصّل (20 حرفاً على الأقل)',
    budgetInvalid: 'راجع المبالغ. يجب أن يكون الأقصى ≥ الأدنى.',
    deadlineInvalid: 'إن حددت موعداً يجب أن يكون في المستقبل.',
    skillsInvalid: 'أضف مهارة مطلوبة واحدة على الأقل.',
    categoryInvalid: 'اختر تصنيفاً صالحاً.',
    experienceInvalid: 'اختر مستوى خبرة صالحاً.',
    addOneSkill: 'أضف مهارة مطلوبة واحدة على الأقل',
    maxSkills: 'بحد أقصى 10 مهارات. احذف بعضها للمتابعة.',
  },
};
