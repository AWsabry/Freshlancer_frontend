...
const translations = {
  ...
  ar: {
    ...
    backToContact: 'العودة إلى اتصل بنا',
    vision: 'رؤيتنا',
    mission: 'مهمتنا',
    whySupport: 'لماذا يهم دعمك',
    supportNow: 'تبرّع الآن',
    visionText: 'أن نبني منظومة ينمّي فيها الطلاب خبرة حقيقية ودخلاً عادلاً ويصل فيها العملاء إلى موهبة مميزة.',
    ...
    reason2Desc: 'نستثمر في الأمان والسرعة والبنية — مساهمتك تُبقي الخدمة موثوقة وقابلة للنمو.',
    ...
    studentAdvantageDesc: 'نظرة جديدة ومهارات رقمية وسرعة تعلّم — جودة عالية بقيمة مناسبة.',
    ...
    internshipPrograms: 'شراكات التدريب',
    internshipProgramsTitle: 'برامج تدريب مع شركات رائدة',
    internshipProgramsDesc: 'نخطط لعروض تدريب حصرية لأفضل الأداء، مع خبرة حقيقية وإمكان توظيف لاحق.',
  },
};
