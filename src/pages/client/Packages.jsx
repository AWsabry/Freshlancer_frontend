...
const translations = {
  ...
  ar: {
    ...
    pointsDescription: 'كل نقطة تفتح ملف طالب (١٠ نقاط لكل فتح)',
    selectCurrency: 'اختر العملة',
    usdComingSoon: 'الدولار قريباً',
    paypalDescription: 'الدفع عبر PayPal بالدولار.',
    paymobDescription: 'الدفع عبر Paymob بالجنيه المصري. بطاقات ومحافظ.',
    buyPointsPackages: 'شراء باقات النقاط',
    noPackagesAvailable: 'لا تتوفر باقات حالياً.',
    hot: 'مميّز',
    mostPopular: 'الأكثر شيوعاً',
    perStudentProfile: 'لكل ملف طالب',
    buyPackage: 'اشترِ الباقة',
    howPointsWork: 'كيف تعمل النقاط',
    step1Title: 'اشترِ نقاطاً',
    step1Description: 'اختر باقة وتتم الشراء',
    step2Title: 'افتح الملفات',
    step2Description: 'استخدم ١٠ نقاط لفتح كل ملف كامل مع بيانات التواصل',
    step3Title: 'تواصل ووظّف',
    step3Description: 'تواصل مع الطلاب مباشرة وابنِ فريقك',
  },
};
