...
const Offers = () => {
  ...
  // Fetch all offers for students
  const { data: offersData, isLoading } = useQuery({
    queryKey: ['studentOffers'],
    queryFn: () => offerService.getAllOffers({ targetAudience: 'student' }),
  });
  ...
  const getOfferBenefit = (offer) => {
    switch (offer.offerType) {
      ...
      case 'free_applications':
        return `+${offer.bonusApplications} Free Applications`;
      case 'premium_trial':
        return `${offer.premiumTrialDays} Days Premium Trial`;
      case 'bundle':
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Exclusive deals and promotions for students</p>
        </div>
        <Button
          variant="primary"
      ...
      {/* All Offers */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-4">All Offers</h2>
