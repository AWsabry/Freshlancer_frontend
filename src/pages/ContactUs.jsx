...
const translations = {
  ...
  ar: {
    heading: 'اتصلي بنا',
    subheading: 'نحن هنا للمساعدة! تواصلي بنا بأي طريقة تناسبك.',
    getInTouch: 'تواصل',
    email: 'البريد',
    whatsapp: 'واتساب',
    telegram: 'تيليجرام',
    contactForm: 'أرسلي رسالة',
    name: 'الاسم',
    subject: 'الموضوع',
    message: 'الرسالة',
    submit: 'إرسال',
    sending: 'جاري الإرسال...',
    success: 'شكراً! سنتواصل قريباً.',
    error: 'فشل الإرسال. حاولي مرة أخرى.',
    required: 'هذا الحقل مطلوب',
    openWhatsApp: 'فتح واتساب',
    openTelegram: 'فتح تيليجرام',
    sendEmail: 'إرسال بريد',
    supportUs: 'ادعمينا',
    supportStudents: 'ساندينا لدعم الطلاب',
    supportDescription: 'مساهمتك تساعد الطلاب وتنمّي منصة فريش لانسر.',
    amount: 'المبلغ',
    currency: 'العملة',
    optionalMessage: 'رسالة (اختياري)',
    supportNow: 'تبرّع',
    processing: 'جاري المعالجة...',
    supportSuccess: 'شكراً! إعادة توجيه للدفع خلال ٣ ثوانٍ...',
    supportError: 'تعذّر إنشاء الطلب.',
    invalidPaymentUrl: 'رابط دفع غير صالح.',
    minAmount: 'الحد الأدنى ١',
    minAmountEGP: 'الحد الأدنى ١٠٠ ج.م',
    enterAmount: 'أدخلي المبلغ',
    learnMore: 'اعرفي المزيد',
    whySupport: 'لماذا نحتاج دعمك',
    processingFeeNote: 'ملاحظة: ٣٪ معالجة للجنيه. الدولار عبر PayPal (٢٫٩٪ + ٠٫٣٠ دولار).',
  },
};
