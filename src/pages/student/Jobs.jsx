...
const translations = {
  ...
  ar: {
    ...
    findOpportunity: 'اعثري على فرصتك عبر فريش لانسر',
    availableJobs: 'الوظائف المتاحة',
    appliedJobs: 'وظائف قدّمتِ لها',
    searchPlaceholder: 'ابحثي بالعنوان أو المهارات...',
    search: 'بحث',
    clear: 'مسح',
    ...
    sortByBudget: 'ترتيب حسب الميزانية',
    sortByBudgetPremium: 'ترتيب حسب الميزانية (للمميز فقط)',
    createdByDesc: 'الأحدث أولاً',
    createdByAsc: 'الأقدم أولاً',
    highestBudgetFirst: 'الأعلى ميزانية أولاً',
    highestBudgetFirstPremium: 'الأعلى ميزانية أولاً 🔒 مميز',
    lowestBudgetFirst: 'الأقل ميزانية أولاً',
    lowestBudgetFirstPremium: 'الأقل ميزانية أولاً 🔒 مميز',
    upgradeToSort: 'رقي حسابك للمميز للترتيب حسب الميزانية',
    filterByCurrency: 'تصفية حسب العملة',
    filterByCurrencyPremium: 'تصفية حسب العملة (للمميز فقط)',
    allCurrencies: 'كل العملات',
    upgradeToFilterCurrency: 'رقي للمميز للتصفية حسب العملة',
    showStartupJobsOnly: 'وظائف الشركات الناشئة فقط',
    showStartupJobsOnlyPremium: 'وظائف ناشئة فقط (للمميز)',
    upgradeToFilterStartups: 'رقي للمميز لعرض وظائف محدّدة',
    noJobsFound: 'لا وظائف',
    tryAdjusting: 'جرّبي تغيير معايير البحث',
    premiumMembersOnly: 'للأعضاء المميزين',
    appliedOn: 'تقديم بتاريخ',
    more: 'المزيد',
    applicants: 'متقدم',
    ...
    endOfList: 'وصلتِ إلى نهاية القائمة',
    urgent: 'عاجل',
    accepted: 'مقبول',
    rejected: 'مرفوض',
