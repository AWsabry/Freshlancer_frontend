...
const translations = {
  ...
  ar: {
    ...
    applicationsRemaining: '{remaining} من {limit} طلبات متبقية هذا الشهر',
    nextBilling: 'الفوترة التالية: {date}',
    selectCurrency: 'العملة',
    usdComingSoon: 'الدولار قريباً',
    payWithPayPal: 'دفع عبر PayPal بالدولار',
    payWithPaymob: 'دفع عبر Paymob بالجنيه',
    currentPlan: 'الخطة',
    free: 'مجاناً',
    perMonth: '/شهر',
    jobApplicationsPerMonth: '{count} طلب وظيفة شهرياً',
    accessToAllListings: 'وصول لكل الوظائف',
    basicProfileVisibility: 'ظهور أساسي للملف',
    emailSupport: 'دعم بريد',
    recommended: 'موصى به',
    premium: 'مميز',
    priorityInSearch: 'أولوية في نتائج البحث',
    featuredProfileBadge: 'شارة مميّزة',
    prioritySupport: 'دعم أولوية',
    premiumBenefits: 'مزايا المميز',
    premiumBenefitsDescription: 'كعضو مميز تحصلين على:',
    unlimitedApplications: '١٠٠ طلب شهرياً',
    unlimitedApplicationsDesc: 'قدّمي على ١٠٠ وظيفة',
    accessToAllListingsPremium: 'وصول لكل الفرص',
    accessToAllListingsPremiumDesc: 'تصفحي وقدّمي',
    priorityInSearchResults: 'أولوية في البحث',
    priorityInSearchResultsDesc: 'ملفك يظهر أولاً',
    featuredProfileBadgePremium: 'شارة مميّزة',
    featuredProfileBadgePremiumDesc: 'تميّزي في الملف',
    priorityCustomerSupport: 'دعم بأولوية',
    priorityCustomerSupportDesc: 'رد أسرع',
    advancedAnalytics: 'تحليلات متقدمة',
    advancedAnalyticsDesc: 'تتبعي أدائك',
    upgradeToPremium: 'الترقية للمميز',
    upgradeSuccess: 'تمت الترقية!',
    upgradeFailed: 'فشلت الترقية',
    cancelSubscription: 'إلغاء الاشتراك',
    cancelDescription: 'يمكنك الإلغاء في أي وقت. يبقى الوصول حتى نهاية الفترة المدفوعة.',
