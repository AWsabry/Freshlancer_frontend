...
const translations = {
  ...
  ar: {
    ...
    noApplicationsYet: 'لم تقدّمي على أي وظيفة بعد.',
    ...
    rejected: 'مرفوض',
    withdrawn: 'مسحوب',
    noApplications: 'لا طلبات',
    noStatusApplications: 'لا طلبات بحالة {status}',
    compactView: 'عرض مضغوط',
    detailedView: 'عرض مفصّل',
    searchPlaceholder: 'ابحثي بعنوان الوظيفة أو العميل...',
    search: 'بحث',
    clear: 'مسح',
  },
};
