...
const translations = {
  ...
  ar: {
    ...
    applicationWithdrawnSuccess: 'تم سحب الطلب',
    withdrawFailed: 'تعذّر سحب الطلب',
    withdrawConfirm: 'هل تريدين سحب هذا الطلب؟ لا يمكن التراجع.',
    applicationDetails: 'تفاصيل الطلب',
    applicationId: 'رقم الطلب:',
    contactUnlockedByClient: 'فتح العميل بيانات التواصل',
    contactUnlockedMessage: 'فتح العميل معلوماتك! قد يتواصل معك مباشرة.',
    premiumMembersOnly: 'للمميز فقط — رقي لمعرفة ما إذا فتح العميل التواصل.',
    pendingMessage: 'طلبك قيد المراجعة.',
    acceptedMessage: 'مبروك! تم قبول طلبك.',
    rejectedMessage: 'لم يُقبَل طلبك لهذه الوظيفة.',
    withdrawnMessage: 'سُحب هذا الطلب.',
    jobWithdrawnMessage: 'سحب العميل الوظيفة. سُحب طلبك تلقائياً.',
    applicationWithdrawnReason: 'سُحب لأن:',
    ...
    viewFullJob: 'وظيفة كاملة',
    upgradeToPremiumEmail: 'رقي للمميز لرؤية البريد',
    urgent: 'عاجل',
    jobBudget: 'ميزانية الوظيفة',
    premiumMembersOnlyBudget: 'للمميز فقط',
    duration: 'المدة',
    posted: 'نُشرت',
    description: 'الوصف',
    ...
    proposalType: 'النوع',
    standard: 'قياسي',
    yourProposedBudget: 'ميزانيتك المقترحة',
    estimatedDuration: 'المدة التقديرية',
    availabilityCommitment: 'التوفر',
    approachMethodology: 'المنهجية',
    methodology: 'المنهج',
    deliveryFrequency: 'تسليم',
    numberOfRevisions: 'المراجعات',
    communicationPreference: 'التواصل',
    relevantExperienceLevel: 'الخبرة',
    backToAllApplications: 'كل الطلبات',
    viewFullJobDetails: 'تفاصيل الوظيفة',
