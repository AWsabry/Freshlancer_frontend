...
const translations = {
  ...
  ar: {
    registrationRequired: 'يلزم إكمال التسجيل',
    completeRegistrationFirst: 'يُرجى إكمال التسجيل أولاً.',
    goToRegistration: 'الذهاب للتسجيل',
    completeStartupProfile: 'أكمل ملف شركتك الناشئة',
    tellUsAboutStartup: 'أخبرنا المزيد عن شركتك',
    startupName: 'اسم الشركة',
    startupNamePlaceholder: 'اسم مميّز',
    startupNameRequired: 'يُرجى إدخال اسم الشركة',
    startupNameMaxLength: 'يجب ألا يتجاوز اسم الشركة 100 حرف',
    yourPosition: 'منصبك',
    positionPlaceholder: 'رئيس، مؤسس، وغيره',
    positionRequired: 'يُرجى إدخال المنصب',
    positionMaxLength: 'يجب ألا يتجاوز المنصب 100 حرف',
    numberOfEmployees: 'عدد الموظفين',
    selectNumberOfEmployees: 'اختر العدد',
    numberOfEmployeesRequired: 'يُرجى اختيار عدد الموظفين',
    employees1_5: '1–5',
    employees6_10: '6–10',
    employees11_20: '11–20',
    employees21_50: '21–50',
    employees51_100: '51–100',
    employees100Plus: '100+',
    startupIndustry: 'مجال الشركة',
    selectIndustry: 'اختر المجال',
    industryRequired: 'يُرجى اختيار المجال',
    technology: 'تقنية',
    ...
    nonProfit: 'غير ربحي',
    other: 'أخرى',
    specifyIndustry: 'حدّد المجال',
    startupStage: 'مرحلة الشركة',
    selectStage: 'اختر المرحلة',
    stageRequired: 'يُرجى اختيار المرحلة',
    idea: 'فكرة',
    mvp: 'MVP',
    earlyStage: 'مرحلة مبكّرة',
    growth: 'نمو',
    scale: 'توسّع',
    completeRegistration: 'إكمال التسجيل',
    unableToCreate: 'تعذر إنشاء ملف الشركة. حاول مرة أخرى.',
    startupCreatedLoginFailed: 'أُنشئت الشركة لكن تسجيل الدخول فشل. سجّل يدوياً.',
  },
};
