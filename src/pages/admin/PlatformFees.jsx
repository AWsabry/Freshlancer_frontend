...
const translations = {
  ...
  ar: {
    title: 'العمولات وإيرادات المنصة',
    subtitle: 'ضبط نسب العمولات وعرض إيرادات المنصة من ودائع الضمان (Escrow).',
    platformFee: 'عمولة المنصة (٪)',
    transactionFee: 'عمولة المعاملة (٪)',
    platformFeeHelp: 'نسبة من مبلغ كل مرحلة (Escrow) كعمولة منصة (0–100).',
    transactionFeeHelp: 'نسبة أخرى لكل مرحلة كعمولة معاملة (0–100).',
    save: 'حفظ',
    saving: 'جارٍ الحفظ...',
    saved: 'تم حفظ الإعدادات.',
    saveError: 'فشل حفظ الإعدادات.',
    income: 'إيرادات المنصة',
    incomeSubtitle: 'باقات العملاء واشتراكات الطلاب وعمولات الضمان. المعاملات المكتملة فقط.',
    usd: 'دولار',
    egp: 'جنيه',
    totalUSD: 'الإجمالي (دولار)',
    totalEGP: 'الإجمالي (جنيه)',
    clientPackages: 'باقات العملاء',
    studentSubscriptions: 'اشتراكات الطلاب',
    escrowFees: 'عمولات الضمان (منصة + معاملة)',
    total: 'الإجمالي',
    source: 'المصدر',
    refresh: 'تحديث',
    dateRange: 'الفترة',
    ...
    failedSettings: 'تعذر تحميل الإعدادات.',
    failedIncome: 'تعذر تحميل الإيرادات.',
    invalidPercentages: 'يُرجى إدخال نِسَب صالحة (0–100).',
    feeRates: 'نسب العمولات',
    calculations: 'أمثلة للحساب',
    calculationsSubtitle: 'بأرقام افتراضية. يدخل الضمان مبلغ المرحلة فقط.',
    milestoneEscrow: 'المرحلة (الضمان)',
    platformFeeAmount: 'عمولة المنصة',
    transactionFeeAmount: 'عمولة المعاملة',
    totalClientPays: 'إجمالي دفع العميل',
  },
};
