...
const translations = {
  ...
  ar: {
    ...
    securePaymentPaypal: 'دفع آمن عبر PayPal',
    paypalRedirect:
      'ستُعاد توجيهك إلى PayPal لإكمال الدفع. يدعم PayPal البطار والحسابات ورصيد PayPal.',
    paypalIntegrationArea: 'منطقة تكامل PayPal',
    paypalIntegrationDesc: 'يُنفّذ هنا دمج PayPal. سيظهر زر الدفع عند الربط.',
    implementationSteps: 'خطوات التنفيذ:',
    acceptedPaymentMethods: 'طرق الدفع المقبولة:',
    creditDebitCards: 'بطاقات ائتمان/خصم',
    cardsList: 'Visa وMastercard',
    paypalBalance: 'رصيد PayPal',
    paypalBalanceDesc: 'الدفع من رصيد PayPal',
    paymentSecure: 'دفعك آمن',
    paymentSecureDesc:
      'تُعالَج المعاملات بشفافية عبر PayPal. بيانات البطاقة لا تُخزَّن على خوادمنا. يوفر PayPal حماية للمشتري.',
    ...
    paypalIntegrationPending: 'تكامل PayPal قيد الانتظار',
    paypalButtonNote: 'سيظهر زر PayPal هنا عند الربط',
    securePaymentPowered: 'دفع آمن عبر PayPal',
    paymentProcessingError: 'خطأ في معالجة الدفع. تواصل مع الدعم.',
    paymentFailed: 'فشل الدفع. حاول مرة أخرى.',
    paypalComingSoon: 'تكامل PayPal قريباً! سيُنفّذ هنا تدفق الدفع.',
  },
};
