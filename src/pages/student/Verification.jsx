...
const translations = {
  ...
  ar: {
    ...
    verificationCompleteMessage: 'تم التحقق من صفتك كطالبة. يمكنك التقديم!',
    verificationPending: 'التحقق قيد المراجعة',
    verificationPendingMessage: 'يُراجع فريقنا الطلب. عادة ٢٤–٤٨ ساعة.',
    verificationRequired: 'التحقق مطلوب',
    verificationRequiredMessage: 'ارفعي مستندات التحقق لبدء التقديم.',
    submitVerificationDocument: 'إرسال مستند',
    documentType: 'نوع المستند',
    documentTypeRequired: 'النوع مطلوب',
    studentIdCard: 'بطاقة طالب',
    enrollmentCertificate: 'شهادة قيد',
    officialTranscript: 'كشف رسمي',
    other: 'أخرى',
    institutionName: 'اسم المؤسسة',
    institutionNamePlaceholder: 'جامعة...',
    institutionNameRequired: 'اسم المؤسسة مطلوب',
    studentIdNumber: 'رقم الطالب',
    studentIdNumberPlaceholder: '١٢٣٤٥٦',
    studentIdRequired: 'رقم الطالب مطلوب',
    enrollmentYear: 'سنة الالتحاق',
    enrollmentYearPlaceholder: '٢٠٢٠',
    enrollmentYearRequired: 'سنة الالتحاق مطلوبة',
    enrollmentYearInvalid: 'سنة غير صالحة',
    expectedGraduationYear: 'سنة التخرج',
    expectedGraduationYearPlaceholder: '٢٠٢٥',
    graduationYearRequired: 'سنة التخرج مطلوبة',
    graduationYearInvalid: 'سنة مستقبلية صالحة',
    uploadDocument: 'رفع مستند',
    uploadFile: 'اختر ملفاً',
    orDragAndDrop: 'أو اسحبي هنا',
    fileTypes: 'PDF أو صورة حتى ١٠ ميجا',
    selected: 'المحدد:',
    ...
    reason: 'السبب:',
    approvedDate: 'تاريخ القبول:',
    documentUploadedSuccess: 'تم الرفع',
    documentUploadFailed: 'فشل الرفع',
    pleaseSelectFile: 'اختر ملفاً',
  },
};
