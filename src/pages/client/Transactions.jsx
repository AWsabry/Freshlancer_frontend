...
const translations = {
  ...
  ar: {
    ...
    unableToLoad: 'تعذر تحميل المعاملات',
    checkConnection: 'تحقق من الاتصال وحاول مرة أخرى.',
    paymentOverview: 'نظرة على المدفوعات',
    totalSpent: 'إجمالي المنفق',
    acrossPayments: 'عبر {count} دفعة ناجحة',
    pointsPurchased: 'النقاط المشتراة',
    totalPointsFromPackages: 'إجمالي النقاط من الباقات',
    transactions: 'المعاملات',
    totalRecords: 'عدد السجلات',
    lastPayment: 'آخر دفعة',
    mostRecentTransaction: 'أحدث معاملة',
    transactionHistory: 'سجل المعاملات',
    refresh: 'تحديث',
    noTransactionsYet: 'لا معاملات بعد',
    noTransactionsMessage: 'بعد شراء باقة نقاط ستظهر التفاصيل هنا.',
    description: 'الوصف',
    amount: 'المبلغ',
    ...
    date: 'التاريخ',
    reference: 'المرجع',
    pointsPackagePurchase: 'شراء باقة نقاط',
    packagePurchase: 'شراء باقة',
    unknown: 'غير معروف',
    needHelp: 'تحتاج مساعدة في الدفع؟',
    helpMessage: 'للمساعدة أو الاسترداد، تواصل مع الدعم مع الرقم المرجعي أعلاه.',
    succeeded: 'ناجح',
    pending: 'معلّق',
    failed: 'فاشل',
    refunded: 'مسترد',
